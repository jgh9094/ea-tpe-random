...
if __name__ == "__main__":    # Example usage
    # read csv file
    df = pd.read_csv('/Users/hernandezj45/Desktop/Repositories/ea-tpe-random/data/task_list.csv')
    ...
    print("source /home/hernandezj45/anaconda3/etc/profile.d/conda.sh")
    print("conda activate tpot2-env-3.10\n")

    print("# todo: define the output and data directory")
    print('DATA_DIR=/home/TODO/data/')
    print("RESULTS_DIR=/home/TODO/results/")
    ...
    for task_id in task_ids:
        lower_bound_list.append(f'TASK_{task_id}_MIN={lower_bound}')
        print(f'TASK_{task_id}_MIN={lower_bound}')
        upper_bound_list.append(f'TASK_{task_id}_MAX={upper_bound}')
    ...
    print("python /home/TODO/Source/runner.py \\")
